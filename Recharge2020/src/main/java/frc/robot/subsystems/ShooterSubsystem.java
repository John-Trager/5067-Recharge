...
public class ShooterSubsystem extends SubsystemBase {
  ...
  /**
   * Runs the shooter based PID
   * RPM controlled relative to trigger value from -1 ro 1
   * @param trigger input device controlling rpm of shooter
   */
